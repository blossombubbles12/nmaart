      ...
      >
        <div className="container mx-auto flex justify-between items-center px-0">
          ...
          <div className="flex items-center gap-4 lg:gap-6">
            ...
            <button className="hidden sm:block px-6 py-2.5 bg-primary hover:bg-primary/80 transition-all rounded-full text-xs font-black text-white tracking-[0.2em]">
              EXPLORE
            </button>
                ...
                {navLinks.map((link, i) => (
                  ...
                  >
                    <Link 
                      ...
                      className="text-6xl md:text-7xl font-black tracking-tighter hover:text-primary transition-colors block py-3 uppercase leading-none"
                    >
                      {link.name}
                    </Link>
                  </motion.div>
